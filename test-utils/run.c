...
#define CLONE_NEWAPPARMOR       0x00001000
...
main(int argc, char *argv[])
{
    ...
    gid_map = NULL;
    uid_map = NULL;
    while ((opt = getopt(argc, argv, "+imnpuUIAM:G:v")) != -1) {
        switch (opt) {
	...
	case 'I': flags |= CLONE_NEWIMA;	break;
	case 'A': flags |= CLONE_NEWAPPARMOR;	break;
